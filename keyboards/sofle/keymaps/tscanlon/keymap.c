...
[_QWERTY] = LAYOUT_via(
   ...
   KC_LCTL, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_VOLD,       KC_PGDN, KC_N    , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT,
                  KC_LGUI,KC_LALT , MO(_LOWER), KC_SPC, KC_ENT,           KC_TAB  , KC_BSPC, MO(_RAISE),KC_RCTL, KC_RGUI
),

[_COLEMAK] = LAYOUT_via(
   KC_ESC, KC_1   , KC_2   , KC_3   , KC_4   , KC_5   ,                          KC_6    , KC_7   , KC_8   , KC_9   , KC_0   , KC_NO,
   KC_DEL, KC_Q   , KC_W   , KC_F   , KC_P   , KC_G   , KC_VOLU,       KC_PGUP,  KC_J    , KC_L   , KC_U   , KC_Y   , KC_SCLN, KC_NO,
   KC_NO , KC_A   , KC_R   , KC_S   , KC_T   , KC_D   , KC_MUTE,       KC_NO  ,  KC_H    , KC_N   , KC_E   , KC_I   , KC_O   , KC_NO,
...
[_LOWER] = LAYOUT_via(
  ...
  _______, KC_NO, KC_NO  , KC_BSLS, KC_LBRC , KC_GRV, _______,       _______, KC_NO, KC_RBRC, KC_QUOT, KC_NO, KC_NO, KC_F12,
  KC_NO  , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , _______,       _______, KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_NO ,
  _______, KC_NO , KC_NO, KC_NO, KC_MINUS, KC_EQL, _______,       _______, KC_LEFT, KC_UP, KC_DOWN, KC_LEFT, KC_NO, _______,
